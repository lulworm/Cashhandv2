...
public:
    ...
    /// Get window identifier of QMainWindow (CASHHANDGUI)
...
bool BitcoinApplication::createWindow(const NetworkStyle* networkStyle)
{
    ...
    window = new CASHHANDGUI(networkStyle, 0);
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if (retval) {
        ...
        if (pwalletMain) {
            ...
            window->addWallet(CASHHANDGUI::DEFAULT_WALLET, walletModel);
            window->setCurrentWallet(CASHHANDGUI::DEFAULT_WALLET);
...
{
    QMessageBox::critical(0, "Runaway exception", CASHHANDGUI::tr("A fatal error occurred. CASHHAND can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
