...
SettingsBitToolWidget::SettingsBitToolWidget(CASHHANDGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsBitToolWidget)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("CASHHAND address"));
