...
SendWidget::SendWidget(CASHHANDGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    /* Address */
    ui->labelSubtitleAddress->setText(tr("CASHHAND address or contact label"));
    ...
    ui->labelAmountSend->setText("0.00 CHND");
