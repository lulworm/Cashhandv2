...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                " <b>" + tr("LOSE ALL OF YOUR CHND") + "</b>!<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            newpassCache = newpass1;
            CASHHANDGUI* window = static_cast<CASHHANDGUI*>(parentWidget());
...
{
    CASHHANDGUI* gui = static_cast<CASHHANDGUI*>(parentWidget());
...
{
    hide();
    static_cast<CASHHANDGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("CASHHAND will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your CHND from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
