...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            /*"  \"zerocoinsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zCHND denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zCHND denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zCHND denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zCHND denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zCHND denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zCHND denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zCHND denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zCHND denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zCHND denominations\n"
            "  }\n"*/
            "  \"keypoololdest\": xxxxxx,      (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,          (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,        (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,           (numeric) the transaction fee set in CHND/kb\n"
            "  \"relayfee\": x.xxxx,           (numeric) minimum relay fee for non-free transactions in CHND/kb\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for CASHHAND cold staking\n"
