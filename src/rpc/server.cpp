...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CASHHAND features */
        {"cashhand", "listmasternodes", &listmasternodes, true, true, false},
        {"cashhand", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cashhand", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cashhand", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cashhand", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cashhand", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cashhand", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cashhand", "masternodedebug", &masternodedebug, true, true, false},
        {"cashhand", "startmasternode", &startmasternode, true, true, false},
        {"cashhand", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cashhand", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cashhand", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cashhand", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cashhand", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cashhand", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cashhand", "preparebudget", &preparebudget, true, true, false},
        {"cashhand", "submitbudget", &submitbudget, true, true, false},
        {"cashhand", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cashhand", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cashhand", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cashhand", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cashhand", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cashhand", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cashhand", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cashhand", "checkbudgets", &checkbudgets, true, true, false},
        {"cashhand", "mnsync", &mnsync, true, true, false},
        {"cashhand", "spork", &spork, true, true, false},
        {"cashhand", "getpoolinfo", &getpoolinfo, true, true, false},
